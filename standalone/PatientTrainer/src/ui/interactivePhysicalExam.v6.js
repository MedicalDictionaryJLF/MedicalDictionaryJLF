...
import { getPhysicalExamMap, PHYSICAL_EXAM_TOOLS } from '../data/physicalExamMap.v6.js';
...
export const PATIENT_VIEW_ASSETS = Object.freeze({
  front: new URL('../../assets/peter_novak_front_52_v6.png', import.meta.url).href,
  back: new URL('../../assets/peter_novak_back_52_v6.png', import.meta.url).href
});
