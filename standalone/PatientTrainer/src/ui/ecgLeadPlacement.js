const FRONT_IMAGE = new URL('../../assets/peter_novak_front.png', import.meta.url).href;
...
export const ECG_ELECTRODES = Object.freeze([
  ...
  electrode('RL', 'Right leg', 'Limb electrode', 39.2, 88.0, 5.5, 'Place on the right lower limb near the ankle.', '#222b38', 'Black', 2),
  electrode('LL', 'Left leg', 'Limb electrode', 60.8, 88.0, 5.5, 'Place on the left lower limb near the ankle.', '#2fa84f', 'Green', -2),
